...
(cl:defmethod cl:initialize-instance :after ((m <Message>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Message)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name realtime-msg:<Message> is deprecated: use realtime-msg:Message instead.")))

(cl:ensure-generic-function 'info-val :lambda-list '(m))
(cl:defmethod info-val ((m <Message>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader realtime-msg:info-val is deprecated.  Use realtime-msg:info instead.")
  (info m))
