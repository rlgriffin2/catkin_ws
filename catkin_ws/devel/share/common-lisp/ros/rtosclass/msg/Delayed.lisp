...
(cl:defmethod cl:initialize-instance :after ((m <Delayed>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Delayed)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rtosclass-msg:<Delayed> is deprecated: use rtosclass-msg:Delayed instead.")))

(cl:ensure-generic-function 'delayed-val :lambda-list '(m))
(cl:defmethod delayed-val ((m <Delayed>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rtosclass-msg:delayed-val is deprecated.  Use rtosclass-msg:delayed instead.")
  (delayed m))
